use {
	super::response::RpcSimulateTransactionResult,
...
impl fmt::Display for RpcResponseErrorData {
	fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
		if let RpcResponseErrorData::SendTransactionPreflightFailure(r) = self {
...
mod tests {
	use {
		super::*,
		crate::rpc_client::config::RpcTokenAccountsFilter,
